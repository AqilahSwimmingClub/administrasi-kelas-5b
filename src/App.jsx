...
export default function App(){
 ...
 const pages={dashboard:<Dashboard data={data} setPage={setPage}/>,students:<Students data={data} setData={setData}/>,attendance:<Attendance data={data} setData={setData}/>,grades:<Grades data={data} setData={setData}/>,schedule:<Schedule data={data} setData={setData}/>,announcements:<Announcements data={data} setData={setData}/>,familyInformation:<FamilyInformation data={data} setData={setData}/>,settings:<Settings data={data} setData={setData} sync={sync}/>,learningObjectives:<LearningObjectives data={data} setData={setData}/>,reportInput:<ReportInput data={data} setData={setData}/>,savedGrades:<SavedGrades data={data} setData={setData}/>,assessmentCheck:<AssessmentCheck data={data}/>,reportCompleteness:<ReportCompleteness data={data} setData={setData}/>,reportPrint:<ReportPrint data={data}/>}
