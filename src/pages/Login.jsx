...
export default function Login({data,onLogin}){
 ...
 return <div className="login-page"><div className="login-art"><GraduationCap size={90}/><h1>Administrasi Kelas 5B</h1><p>Kelola data kelas, absensi, nilai, dan komunikasi orang tua dalam satu aplikasi.</p></div><form className="login-card" onSubmit={submit}>
