...
<div class="ornament"><div class="corner tl">❧</div><div class="corner tr">❧</div><div class="corner bl">❧</div><div class="corner br">❧</div>
...
<p class="prepared">Disusun oleh : ${esc(s.teacher)}</p></div></section>`
...
<table class="grade-print"><thead><tr><th rowspan="3">NO.<br>URUT</th><th rowspan="3">NO.<br>INDUK</th><th rowspan="3" class="name">NAMA</th><th colspan="20">FORMATIF</th><th colspan="5">SUMATIF LINGKUP<br>MATERI</th><th rowspan="3">SUMATIF<br>AKHIR<br>SEMESTER</th></tr>
...
<tbody>${data.students.map((s,i)=>`<tr><td>${i+1}</td><td>${esc(s.nis)}</td><td class="left">${esc(s.name)}</td>${gradeFields.map(f=>`<td>${esc(map[`${s.id}|${subject}|${semester}|${f}`]??'')}</td>`).join('')}</tr>`).join('')}</tbody></table>
...
export function printGradeBook(data,semester,onlySubject=null){
 ...
 @page{size:A4 portrait;margin:8mm}@page grade{size:A4 landscape;margin:5mm}*{box-sizing:border-box}body{font-family:"Times New Roman",serif;margin:0;color:#000}.page{page-break-after:always;min-height:277mm}.ornament{height:277mm;border:4px double #000;padding:18mm 15mm;position:relative}.corner{position:absolute;font-size:46px}.tl{left:4px;top:0}.tr{right:4px;top:0;transform:scaleX(-1)}.bl{left:4px;bottom:0;transform:scaleY(-1)}.br{right:4px;bottom:0;transform:scale(-1)}.cover h1{text-align:center;font-size:27px;margin:22mm 0 18mm}.logo{text-align:center;font-size:96px;margin:10mm}.identity-cover,.term{border-collapse:collapse;width:82%;margin:0 auto;font-size:15px}.identity-cover th,.term th{text-align:left}.identity-cover td,.identity-cover th,.term td,.term th{padding:2px}.term{margin-top:34mm;width:55%}.prepared{margin-top:15mm;margin-left:8%;font-size:13px}.identity h1{text-align:center;margin-top:20mm}.id-box{text-align:center;margin-top:35mm;font-size:20px}.compiled{margin:80mm 15mm 0;font-size:16px}.grade-page{page:grade;min-height:190mm}.grade-page h2,.grade-page h3{text-align:center;margin:0;font-size:16px}.meta{display:grid;grid-template-columns:42mm 1fr;max-width:170mm;margin:4mm 0 2mm;font-size:12px}.grade-print{width:100%;border-collapse:collapse;table-layout:fixed;font-family:Arial,sans-serif;font-size:6.5px}.grade-print th,.grade-print td{border:1px solid #000;text-align:center;padding:1px;height:4.2mm}.grade-print th{font-weight:700}.grade-print .name{width:34mm}.grade-print th:nth-child(1){width:7mm}.grade-print th:nth-child(2){width:14mm}.grade-print .left{text-align:left;padding-left:2px;font-size:7px}.footer-sign{display:flex;justify-content:flex-end;gap:70mm;margin:4mm 20mm 0;font-size:10px}.footer-sign>div:last-child{text-align:left}@media print{button{display:none}}
